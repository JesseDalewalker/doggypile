  ...
  return (
    <div>
          ...
          <Col>
            ...
            <div className='links-div'>
              <ListGroup variant="flush">
                <ListGroup.Item action href="https://www.rspcapetinsurance.org.au/pet-care/dog-care/what-should-feed-dog#:~:text=It%20is%20entirely%20acceptable%20to,need%20to%20be%20aware%20of.">More information on what to feed your dog available here!</ListGroup.Item>
                <ListGroup.Item action href="https://www.campbellrivervet.com/often-take-dog-vet/#:~:text=Annual%20wellness%20exam,any%20concerns%20with%20your%20vet.">More information on veterinarian visits available here!</ListGroup.Item>
                <ListGroup.Item action href="https://www.akc.org/expert-advice/health/keep-dog-teeth-clean/">More information on doggy dental care available here!</ListGroup.Item>
                <ListGroup.Item action href="https://www.akc.org/expert-advice/health/how-much-exercise-does-dog-need/">More information on exercising your dog available here!</ListGroup.Item>
              </ListGroup>
            </div>
          </Col>
        </Row>
      ...
      <div className='d-flex justify-content-center links-div vet'>
        ...
        <Button href="http://www.usa-veterinarians.com/" className='edit-btn'>Search Now</Button>
        </div>
      </div>
