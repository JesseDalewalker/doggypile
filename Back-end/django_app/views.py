...
class UserViewset(ModelViewSet):
    ...
    def get_permissions(self):
        ...
        return (permissions.IsAuthenticatedOrReadOnly(),) # this makes sure that only admin users have access to CRUD users i.e. if submitting a request other than a POST request 
